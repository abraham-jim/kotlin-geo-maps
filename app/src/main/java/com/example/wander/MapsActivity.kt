...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
     ...
     *
     * latitude":33.781661999999997,"longitude":-118.187983,
     */
    override fun onMapReady(googleMap: GoogleMap) {
        map = googleMap

        //These coordinates represent the latitude and longitude of the ----.
        val latitude = 33.781661999999997
        val longitude = -118.187983
        val zoomLevel = 15f
